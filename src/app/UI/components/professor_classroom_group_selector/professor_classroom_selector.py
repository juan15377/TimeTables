...
class SelectorBase:
    ...
    def __init__(self, db, entity_type, callback=None, default_selected = None):
        self.db = db
...
class ProfessorSelector(SelectorBase):
    def __init__(self, db, callback=None, id_default_selected = None):
        super().__init__(db, "PROFESSOR", callback, id_default_selected)
...
class ClassroomSelector(SelectorBase):
    def __init__(self, db, callback=None, id_default_selected = None):
        super().__init__(db, "CLASSROOM", callback, id_default_selected)

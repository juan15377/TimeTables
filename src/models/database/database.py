...
class BaseManager:
    ...
    def __init__(self, type_, db_connection):
        ...
        valid_types = {"PROFESSOR", "CLASSROOM", "GROUPS"}
        if type_ not in valid_types:
            raise ValueError("Tipo no válido")
...
class GroupsManager(BaseManager): 
    ...
    def __init__(self, db_connection):
        ...
        super().__init__("GROUPS", db_connection)
    ...
    def new(self, id_career, id_semester, id_subgroup):
        ...
        cursor.execute(f"INSERT INTO {self.type_} (CAREER, SEMESTER, SUBGROUP) VALUES (?, ?, ?)", (id_career, id_semester, id_subgroup))
...
class DataBase:
    ...
    def __init__(self, db_connection):
        ...
        self.export = ExportFunctionsManager(self.db_connection)
